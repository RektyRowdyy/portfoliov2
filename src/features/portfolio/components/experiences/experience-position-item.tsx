          ...
          {position.skills.map((skill, index) => {
            ...
            return (
              <li key={index} className="flex">
                <span className="flex items-center gap-1.5 rounded-full bg-zinc-50 px-1.5 py-0.5 font-mono text-xs text-foreground ring-1 ring-border/80 select-none dark:bg-zinc-900 [&_img]:size-3.5">
                  {iconKey && (
                    <Image
